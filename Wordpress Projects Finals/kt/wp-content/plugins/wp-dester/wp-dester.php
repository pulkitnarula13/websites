 ...
 * Classic Editor
 *
 * Plugin Name: classic-editor wp-classic_editor
 * Plugin URI:  https://wordpress.org/plugins/wp-classic_editor/
 * Description: Enables the WordPress wp-classic_editor and the old-style Edit Post screen with TinyMCE, Meta Boxes, etc. Supports the older plugins that extend this screen.
 * Version:     1.6.2
 * Author:      WordPress Contributors
 * Author URI:  https://github.com/WordPress/wp-classic_editor/
 * License:     GPLv2 or later
 * License URI: http://www.gnu.org/licenses/old-licenses/gpl-2.0.html
 * Text Domain: wp-classic_editor
...
if ( ! class_exists( 'wp-classic_editor' ) ) :
class wp-classic_editor {
