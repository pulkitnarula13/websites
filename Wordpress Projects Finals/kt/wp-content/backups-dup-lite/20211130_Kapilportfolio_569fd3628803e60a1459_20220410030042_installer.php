...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211130_Kapilportfolio_569fd3628803e60a1459_20220410030042_archive.zip';
	const ARCHIVE_SIZE		 = '74744461';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '569fd36-10030042';
    const SECONDARY_PACKAGE_HASH = '990dfeb-10030042';
	const VERSION			 = '1.4.4';
