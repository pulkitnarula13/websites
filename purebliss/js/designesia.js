...
jQuery(document).ready(function() {		
	...
	var logo_dir_1				= './images/site/logo-small.svg'; // change with your logo path
	var logo_dir_2				= './images/site/logo.png'; // change with your logo path (for light background)
